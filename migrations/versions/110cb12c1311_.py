...
Revision ID: 110cb12c1311
Revises: 
Create Date: 2023-02-24 19:48:53.746676
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    with op.batch_alter_table('user', schema=None) as batch_op:
        batch_op.add_column(sa.Column('username', sa.VARCHAR(length=250), autoincrement=False, nullable=True))
